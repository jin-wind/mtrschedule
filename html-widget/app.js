...
// Toggle always-on-top (Note: This requires Electron or similar framework for true always-on-top)
function togglePin() {
    isPinned = !isPinned;
    ...
    if (isPinned) {
        ...
        pinBtn.title = '取消固定';
        // In a browser environment, we can make the window smaller and positioned
